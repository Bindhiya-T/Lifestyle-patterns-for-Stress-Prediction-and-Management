...
st.title('Human Stress Level Prediction 💤')
...
if selected == "Prediction":
    ...
    with features:
        ...
        def load_model():
            ...
            """
            with open('Models_pkl\model.pkl', 'rb') as f:
                model = pickle.load(f)
            return model

        gender_le = joblib.load('Models_pkl\gender_encoder.pkl')
        occupation_le = joblib.load('Models_pkl\occupation_encoder.pkl')
        bmiCategory_le = joblib.load('C:\\Users\\Bindhiya\\OneDrive\\Desktop\\Sleep Health Prediction\\Models_pkl\\bmi_category_encoder.pkl')
        sleepDisorder_le = joblib.load('Models_pkl\sleep_disorder_encoder.pkl')
        scaler = joblib.load('C:\\Users\\Bindhiya\\OneDrive\\Desktop\\Sleep Health Prediction\\Models_pkl\\scaler.pkl')
...
if selected == "Contact":
    ...
    html_path = 'Contact_page\index.html'
    css_path ='Contact_page\style.css' 
